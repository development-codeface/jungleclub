    ...
    var tpl = {
        "font-styles": function(locale, options) {
            ...
            return "<li class='dropdown'>" +
              ...
              "<i class='ti-text'></i>&nbsp;<span class='current-font'>" + locale.font_styles.normal + "</span>&nbsp;<b class='caret'></b>" +
              "</a>" +
        ...
        "lists": function(locale, options) {
            ...
            return "<li>" +
              "<div class='btn-group'>" +
                "<a class='btn" + size + "' data-wysihtml5-command='insertUnorderedList' title='" + locale.lists.unordered + "'><i class='ti-list'></i></a>" +
                "<a class='btn" + size + "' data-wysihtml5-command='insertOrderedList' title='" + locale.lists.ordered + "'><i class='ti-list-ol'></i></a>" +
                "<a class='btn" + size + "' data-wysihtml5-command='Outdent' title='" + locale.lists.outdent + "'><i class=' ti-shift-left'></i></a>" +
                "<a class='btn" + size + "' data-wysihtml5-command='Indent' title='" + locale.lists.indent + "'><i class=' ti-shift-right'></i></a>" +
              "</div>" +
            "</li>";
        },
        ...
        "link": function(locale, options) {
            ...
            return "<li>" +
              ...
              "</div>" +
              "</div>" +
              "<a class='btn" + size + "' data-wysihtml5-command='createLink' title='" + locale.link.insert + "'><i class='ti-link'></i></a>" +
            "</li>";
        },
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
              ...
              "</div>" +
              "</div>" +
              "<a class='btn" + size + "' data-wysihtml5-command='insertImage' title='" + locale.image.insert + "'><i class='ti-gallery'></i></a>" +
            "</li>";
        },
        ...
        "html": function(locale, options) {
            ...
            return "<li>" +
              "<div class='btn-group'>" + 
                "<a class='btn" + size + "' data-wysihtml5-action='change_view' title='" + locale.html.edit + "'><i class='ti-pencil'></i></a>" +
              "</div>" +
            "</li>";
        },
