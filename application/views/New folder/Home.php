...
$this->output->set_header("");  
	...
	//	  $name    = $this->input->post('name');
					   ...
					   foreach ($check as $vals)
          {
					...
					if(!$check || $check == FALSE)
				{
					...
					redirect('http://localhost/jungle/',"refresh");
				}
				else if($user_role==3)
	           {
 ...
 //$this->load->view('detail');
		...
		public function signout()
	{
		...
		public function booking_confirmss()
	{
...
$this->load->view('mail',$data);
   ...
   //  $this->data['details']        = $this->obj_model->getlocdetail($loc_id);
	...
	$address		=	 $this->input->post('address');
		$state_country =	 $this->input->post('statecountry');
 ...
 //
     $user_item= array(
               ...
               $this->obj_model->common_update($user_id, "user_id", "user_details", $user_item);
...
//	echo $no_person;echo $no_tent;echo $from;echo $to;echo $loc_id;echo $no_tent_avail;echo $tent_rate;echo $allowed_person;exit;
	...
	public function select_login_details()
	{	
...
public function checkmail(){
	...
	//print_r($data);exit;
	$data['countries'] =  $this->obj_model->get_table('countries',array('status' => '1'));
//	print_r($data);exit;
		$this->load->view('admin/addlocation',$data);
	
	}	
	public function savelocationbk()
	{	
	...
	{	
        	...
        	// print_r($data['sub_category']);exit;
        	// $this->load->view($this->list_adverisements,$data);
			$data['location'] =  $this->obj_model->get_table('location_detail',array('status' => '1'));
	  ...
	  public function uploadlocimage()
    {
	...
	$data['location'] =  $this->obj_model->get_table('location_detail',array('status' => '1'));
	  ...
	  public function uploadgallimage()
    {
	...
	$data['location'] =  $this->obj_model->get_table('location_detail',array('status' => '1'));
	  ...
	  public function uploadhomesliderimage()
    {
	...
	$data['location'] =  $this->obj_model->get_table('location_detail',array('status' => '1'));
	  ...
	  public function updatehomesliderimage()
    {
	  ...
	  public function updateuploadlocimage()
    {
	...
	$data['list'] = $this->obj_model->get_location_detail();
	  ...
	  public function updategallimage()
    {
...
$gstsum=$tot+$gst;
 echo json_encode(array(
                'status' => 1, 'days' => $days, 'total' => $tot,'gstsum' => $gstsum
            ));
	...
	public function persomminimise()
	{
...
$gstsum=$tot+$gst;
 ...
 echo json_encode(array(
                'status' => 1,  'total' => $tot,'gstsum' => $gstsum,'no' => $nope
            ));
...
*/
	...
	{	
	  ...
	  public function uploaddistrictimage()
    {
	...
	//print_r($data);exit;
		...
		public function editdistrictimage()
	{	
...
//	$data['home_image']= $this->obj_model->get_table('home_images',array('status' => '1'));
       ...
       // 	print_r($data);
		...
		public function updatedistrictimage()
	{
	  ...
	  //echo $height;
		...
		public function deletedistrictimage()
	{	
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		public function deletehomeimageedit()
	{	
		...
		public function deletelocationimageedit()
	{	
	...
	public function deletegallaryimageedit()
	{	
...
$pack_id = $this->uri->segment(3);
	...
	//$data['package'] = $this->obj_model->get_thum_pack($pack_id);
...
//	print_r($data);exit;
	...
	$data['chkout']  = $this->input->post('datepicker-13');
		 $fname   = $this->input->post('fname'); $lname   = $this->input->post('lname');	 $email   = $this->input->post('emailids');	 $mobile   = $this->input->post('mobile');
...
//print_r($data);
   ...
   //     $this->load->view("detail", $this->data);
	...
	public function select_detailsbk()
	{
   ...
   //  $this->data['details']        = $this->obj_model->getlocdetail($loc_id);
	...
	$this->order['bookingstartdate']= $this->input->post('datepicker-12');
	$this->order['bookingenddate']= $this->input->post('datepicker-13');
	$this->order['bookedby']= $user_id;
	$this->order['primaryguest']= $user_id;
	$this->order['package']=  $this->input->post('pkd');
	$this->order['amount']= $this->input->post('packpr');
	$this->order['packagecount']=$this->input->post('nopac');
$this->order['no_pesrson']=$this->input->post('no_pesrson');
$this->order['packagecount']=$this->input->post('nopac');
$this->order['packagecount']=$this->input->post('noday');
