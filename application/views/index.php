					...
					<div class="tg-sliderarea">
						...
						<div class="tg-trendingtripsslider tg-trendingtrips owl-carousel">
							<div class="item tg-trendingtrip">
								<figure>
									<a href="javascript:void(0);">
										<img src="img/tours/img-05.jpg" alt="image destinations">
										<div class="tg-hover">
							...
							<div class="item tg-trendingtrip">
								<figure>
									<a href="javascript:void(0);">
										<img src="img/tours/img-06.jpg" alt="image destinations">
										<div class="tg-hover">
											<span class="tg-stars"><span></span></span>
											<span class="tg-tourduration">7 Days</span>
											<span class="tg-locationname">Paris</span>
							...
							<div class="item tg-trendingtrip">
								<figure>
									<a href="javascript:void(0);">
										<img src="img/tours/img-07.jpg" alt="image destinations">
										<div class="tg-hover">
											<span class="tg-stars"><span></span></span>
											<span class="tg-tourduration">7 Days</span>
											<span class="tg-locationname">Paris</span>
							...
							<div class="item tg-trendingtrip">
								<figure>
									<a href="javascript:void(0);">
										<img src="img/tours/img-08.jpg" alt="image destinations">
										<div class="tg-hover">
											<span class="tg-stars"><span></span></span>
											<span class="tg-tourduration">7 Days</span>
											<span class="tg-locationname">Paris</span>
			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="tg-navigationarea tg-headerfixed">
						<strong class="tg-logo"><a href="index.html"><img src="img/logo.png" alt="company logo here"></a></strong>
							...
							<div class="tg-userbox">
								...
								<div class="dropdown tg-dropdown">
									<button class="tg-btndropdown" id="tg-dropdowndashboard" type="button" data-toggle="dropdown">
										<img src="img/author/img-01.jpg" alt="image description">
							...
							<div id="tg-navigation" class="collapse navbar-collapse tg-navigation">
								<ul>
									...
									<li class="menu-item-has-children"><a href="javascript:void(0);">Destinations</a>
										...
										<li><a href="<?php echo base_url();?>contact">Contaxxxxcts Us</a></li>
