                    ...
                    <form class="tg-formtheme tg-formtrip " method="post" action="<?php echo base_url(); ?>index.php/Home/searchpackage" name="signddupform" id="signddupform" enctype="multipart/form-data"  >
                                ...
                                <fieldset>
									...
									<div class="form-group">
																	 ...
																	 <input type = "text" id = "datepicker-12" name = "datepicker-12" class="date_field" placeholder="Check In"> 
															</div>
															<div class="form-group"> 
															
															<!-- <input type="date" class="date_field" id="to" name="to"/>  -->
															 <input type = "text" id = "datepicker-13" name = "datepicker-13" class="date_field" placeholder="Check Out">
															</div> 
...
<div class="item tg-populardestination">
										<figure>
											<a href="javascript:void(0);"><img src="<?php echo base_url(); ?>uploads/location/<?php echo $lo['imagename'] ?>" alt="image destinations"></a>
											<figcaption>
												<h3><a href="javascript:void(0);"><?php echo $lo['c_name'] ?></a></h3>
												<div class="tg-description">
...
<!--************************************
			...
			*************************************-->
			<section class="tg-parallax" data-appear-top-offset="600" data-parallax="scroll" data-image-src="images/bgparallax-01.jpg">
					...
					<div class="container">
						<div class="row">
							...
							<div class="item tg-destination">
								<figure>
									<a href="#"><img src="<?php echo base_url(); ?>uploads/packagethumbnail/<?php echo $po['imagename'] ?>"></a>
									<figcaption>
										<h2><a href="#"><?php echo $po['package'] ?></a></h2>
										<div class="tg-description">
...
<script type="text/javascript" src="<!?php echo base_url(); ?>js/jquery_validation/jquery.validate.js"></script>
	...
	<script type="text/javascript"> 
	 ...
	 $("#signddupform").validate({
			...
			datepicker-13:"required",datepicker-12:"required"
				
             },
            messages: {
              district_id:"Please choose the field"    ,
	     datepicker-12:"Please choose the field",   datepicker-13:"Please choose the field" 
