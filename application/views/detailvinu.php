		...
		*************************************-->
		<div class="tg-bannerholder">
			...
			<div id="tg-homeslider" class="tg-homeslider owl-carousel tg-haslayout">
				<figure class="item_detail" data-vide-bg="<?php echo base_url(); ?>images/parallax/bgparallax-01.jpg" data-vide-options="position: 0% 50%"></figure>
				<figure class="item_detail" data-vide-bg="<?php echo base_url(); ?>images/parallax/bgparallax-02.jpg" data-vide-options="position: 0% 50%"></figure>
				<figure class="item_detail" data-vide-bg="<?php echo base_url(); ?>images/parallax/bgparallax-04.jpg" data-vide-options="position: 0% 50%"></figure>
			</div>
		</div>
		<!--************************************
				Home Slider End
                            ...
                            <?php echo "total available tent $frq->no_tent; " ?>
															...
															<div class="form-group">
																<label style="color: #fff;">Check In</label>
																	 <input type = "text" id = "datepicker-12"class="date_field"> 
															</div>
															<div class="form-group"> 
																 <label style="color: #fff;">Check Out</label>
															<!-- <input type="date" class="date_field" id="to" name="to"/>  -->
															 <input type = "text" id = "datepicker-13" class="date_field">
															</div> 
														  ...
														  <?php 
														$lo=  $frq->detail_id;
														  $query=$this->db->query("select * from location where loc_id=$lo");
        $result=$query->result();
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
										...
										id="myModal4">
                                            ...
                                            &nbsp;&nbsp;OR &nbsp;&nbsp;
                                            <button type="submit" class="btn btn-primary" style="background-color: #d24655;border: none" name="fre"
										id="fre">
