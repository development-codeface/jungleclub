			...
			<div class="container">
				<div class="row">
					<div id="tg-twocolumns" class="tg-twocolumns">
						<form class="tg-formtheme tg-formdashboard" method="post" action="<?php echo base_url(); ?>index.php/Home/setnewpass" name="confirm" id="confirm">
												...
												<div class="tg-content">
													<fieldset>
														<div class="form-group cps">
															...
															<input type="text" name="first"  class="form-control" placeholder="">
														</div>
														<div class="form-group cps">
															<label>Confirm Password<sup>*</sup></label>
															<input type="text" name="second" class="form-control" placeholder="">
														</div>
