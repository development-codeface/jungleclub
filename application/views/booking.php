													...
													<div class="tg-widgetpersonprice">
														<div class="tg-widgetcontent">
															<ul>
															 ...
															 <li class="tg-personprice"style="border-top: 1px solid #e6e6e6; background: #f1f1f1;"><div class="tg-perperson"style="width:50%;" ><span style=" padding-left: 11%;" >Checkin</span><!-- <label style="display:inline-block;margin-left:10px;color:#9b9e06;font-weight: bold;"><?php // echo date("d-m-Y", strtotime($from));  ?></label> --><!-- <input type="date" class="date_field" id="to" name="to"/ style="width:80%;height:30px; "> --><p> <input type = "text" id ="in" name ="in" class="calend_input chngdate" readonly value=" <?php echo date("d-m-Y", strtotime($chkin));  ?>"></p></div>
															 
															 
															 
															 <div class="tg-perperson"style="width:50%;"><span style=" padding-left: 11%;" >Checkout</span><!-- <input type="date" class="date_field" id="to" name="to"/ style="width:80%;height: 30px;"></div> --><p>
...
$tot=$pak['packageprize']*$no;
	  ...
	  <input name="nopac" id="nopac" type="hidden" value="<?php  echo $no; ?>"> 
															...
															<li class="tg-personprice"><div class="tg-perperson"><span>Package Price  (<div id="ww" style="display:inline-block;"><?php echo $no; ?></div> x <?php echo $pak['packageprize'] ?>)</span><em id="baseprice"><?php echo $tot; ?></em></div></li>
																<li  class="tg-personprice"><span>Sub Total</span><em id="subtotal"><?php echo $tot; ?></em></li>
														<?php $gst=0; ?>
														  <input name="gst" id="gst" type="hidden" value="<?php echo $gst; ?>">
																<li  class="tg-personprice"><span>Tax Rate</span><em><?php echo $gst; ?> </em></li>
																<?php $sum= $tot+$gst; ?>
