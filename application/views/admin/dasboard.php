								...
								<div id="tg-content" class="tg-content">
									<div class="tg-dashboard">
										<div class="tg-box tg-profile">
											...
											<?php //if($frq->profile_pic !=null)
											//{
												?>
											
												<figure>	   <img src="<?php // echo base_url() .'uploads/profile_pic/'.$frq->profile_pic ;?>" alt="" style="width:127px; height=169px;"></figure>
											<?php //} else
										//	{
											...
											<!--	
													...
													<td><span><?php echo $frq->first_name.' '.$frq->last_name; ?></span></td>
													...
													<td><span><?php echo $frq->address; ?></span></td>
													</tr>
													<tr>
													<th><span>Country/state</span></th>
													<td><span><?php echo $frq->state_country; ?></span></td>
													</tr>
													<tr>
													<th><span>Town/City</span></th>
													<td><span><?php echo $frq->town_city; ?></span></td>
													</tr><tr>
													<th><span>Postcode</span></th>
													<td><span><?php echo $frq->pin; ?></span></td>
													</tr>
													</table> -->
												</div>
