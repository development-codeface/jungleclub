...
<body class="skin-default fixed-layout">
    ...
    <div id="main-wrapper">
                           ...
                           <!--  <h5 class="card-subtitle"> Bootstrap Elements </h5> -->
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                     <form class="tg-formtheme tg-formtrip " method="post" action="<?php echo base_url(); ?>index.php/Home/savepackage" name="savepak" id="savepak" enctype="multipart/form-data" >
                                       ...
                                       <div class="form-group">
                                        ...
                                        <textarea class="textarea_editor form-control" rows="15" id="" name="Description" placeholder="Enter text ..."></textarea>
                                    </div>
                            ...
                            <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="noperson"  name="noperson" placeholder="Number of person">
                                        </div>
      ...
      <input type="radio" class="custom-control-input" id="minimal-radio-1" checked name="example1">
      <label class="custom-control-label rao" for="minimal-radio-1">Activate</label>
    </div></div>
    <div class="col-md-5 col-sm-5 col-xs-5">
    <div class="custom-control custom-radio">
      <input type="radio" class="custom-control-input" id="minimal-radio-2" name="example1">
      <label class="custom-control-label rao" for="minimal-radio-2">Deactivate</label>
    </div>    
...
Upload <input type="file" class="uploadFile img" value="Upload Photo" id="thumbnail" name="thumbnail"  style="width: 0px;height: 0px;overflow: hidden;">
                </label>
    ...
    <div class="imagePreview"></div>
<label class="btn btn-primary bbbn">
Upload <input type="file" class="uploadFile img" id="slid" name="slid" value="Upload Photo" style="width: 0px;height: 0px;overflow: hidden;">
                </label>
    ...
    <div class="imagePreview"></div>
<label class="btn btn-primary bbbn">
Upload <input type="file" id="input-file-now-custom-2"  name="slid2" class="uploadFile img" value="Upload Photo" style="width: 0px;height: 0px;overflow: hidden;">
                </label>
    ...
    <div class="imagePreview"></div>
<label class="btn btn-primary bbbn">
Upload <input type="file" id="input-file-now-custom-2"  name="slid3" class="uploadFile img" value="Upload Photo" style="width: 0px;height: 0px;overflow: hidden;">
                </label>
...
<div class="card-body">
    ...
    <div class="imagePreview"></div>
<label class="btn btn-primary bbbn">
Upload <input type="file" id="input-file-now-custom-2" name="gal1" class="uploadFile img" value="Upload Photo" style="width: 0px;height: 0px;overflow: hidden;">
                </label>
...
<div class="col-lg-4 col-md-4 imgUp">  <!-- <i class=" icon-plus imgAdd"></i>    -->
    ...
    <div class="imagePreview"></div>
<label class="btn btn-primary bbbn">
Upload <input type="file" id="input-file-now-custom-2" name="gal2" class="uploadFile img" value="Upload Photo" style="width: 0px;height: 0px;overflow: hidden;">
                </label>
    ...
    <div class="imagePreview"></div>
<label class="btn btn-primary bbbn">
Upload <input type="file" class="uploadFile img" id="input-file-now-custom-2" name="gal3" value="Upload Photo" style="width: 0px;height: 0px;overflow: hidden;">
                </label>
    ...
    <div class="imagePreview"></div>
<label class="btn btn-primary bbbn">
Upload <input type="file" class="uploadFile img" id="input-file-now-custom-2" name="gal4" value="Upload Photo" style="width: 0px;height: 0px;overflow: hidden;">
                </label>
    ...
    <div class="imagePreview"></div>
<label class="btn btn-primary bbbn">
Upload <input type="file" class="uploadFile img" id="input-file-now-custom-2" name="gal5" value="Upload Photo" style="width: 0px;height: 0px;overflow: hidden;">
                </label>
    ...
    <div class="imagePreview"></div>
<label class="btn btn-primary bbbn">
Upload <input type="file" class="uploadFile img" id="input-file-now-custom-2" name="gal6" value="Upload Photo" style="width: 0px;height: 0px;overflow: hidden;">
                </label>
...
<script type="text/javascript" src="<!?php echo base_url(); ?>js/jquery_validation/jquery.validate.js"></script>
	...
	<script type="text/javascript"> 
	 ...
	 $("#savepak").validate({
	     ...
	     package:"Please enter the package" ,
		 days:"Please enter the days" ,
		 discription:"Please enter the discription"    ,
...
<script language="javascript">
 ...
 //alert(l_id);
   ...
   $.ajax({
            ...
            url: "<?php echo base_url(); ?>index.php/Home/getamiCategory",
            data: {l_id: l_id, section_id: section_id},
            dataType: "json",
